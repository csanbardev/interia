...
CREATE TABLE `t_tutorials` (
  ...
  `tut_usr_id` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `tut_fk1` FOREIGN KEY (`tut_usr_id`) REFERENCES `t_users` (`usr_id`) ON DELETE SET NULL,
...
(27,'https://www.youtube.com/watch?v=cHILwQ1h8g8','0','2022-03-26',2,43,NULL,'Los 6 Peores ERRORES!! que tienes que EVITAR a la HORA de SOLDAR con ESTAÑO','electrojungla','https://i.ytimg.com/vi/cHILwQ1h8g8/mqdefault.jpg','10m. 42s.',31096);
...
-- Dump completed on 2024-01-09 17:22:37
